            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.persistFiles = new ArrayList<PersistFile>(_list8.size);
                PersistFile _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new PersistFile();
                  _elem9.read(iprot);
                  struct.persistFiles.add(_elem9);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PersistCommandOptions struct) throws org.apache.thrift.TException {
      ...
      if (struct.persistFiles != null) {
        oprot.writeFieldBegin(PERSIST_FILES_FIELD_DESC);
        {
          ...
          for (PersistFile _iter11 : struct.persistFiles)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetPersistFiles()) {
        {
          ...
          for (PersistFile _iter12 : struct.persistFiles)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.persistFiles = new ArrayList<PersistFile>(_list13.size);
          PersistFile _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new PersistFile();
            _elem14.read(iprot);
            struct.persistFiles.add(_elem14);
          }
        }
        struct.setPersistFilesIsSet(true);
      }
