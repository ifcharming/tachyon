...
public class WorkerInfo implements org.apache.thrift.TBase<WorkerInfo, WorkerInfo._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerInfo> {
  ...
  private tachyon.thrift.WorkerNetAddress address; // required
  ...
  public WorkerInfo(
    long id,
    tachyon.thrift.WorkerNetAddress address,
    int lastContactSec,
    String state,
    long capacityBytes,
    long usedBytes,
  ...
  public WorkerInfo(WorkerInfo other) {
    ...
    if (other.isSetAddress()) {
      this.address = new tachyon.thrift.WorkerNetAddress(other.address);
    }
  ...
  public tachyon.thrift.WorkerNetAddress getAddress() {
    return this.address;
  }

  public WorkerInfo setAddress(tachyon.thrift.WorkerNetAddress address) {
    this.address = address;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ADDRESS:
      if (value == null) {
        ...
        setAddress((tachyon.thrift.WorkerNetAddress)value);
      }
      break;
        ...
        switch (schemeField.id) {
          ...
          case 2: // ADDRESS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.address = new tachyon.thrift.WorkerNetAddress();
